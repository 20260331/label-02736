    ...
    render() {
        ...
        this.container.innerHTML = `
            <div class="page-header">
                ...
                <p class="page-desc">${this.isEdit ? '修改成绩信息' : '录入新的学生成绩'}</p>
            </div>
            <div class="page-content">
    ...
    bindEvents() {
        ...
        form.addEventListener('submit', async (e) => {
            ...
            const data = {
                ...
                exam_time: document.getElementById('exam_time').value || null
            };
            ...
            if (data.exam_time) {
                try {
                    new Date(data.exam_time).toISOString();
                } catch (e) {
                    this.showError('exam_time', '考试时间格式不正确');
                    hasError = true;
                }
            }
